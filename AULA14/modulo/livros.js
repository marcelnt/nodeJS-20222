...
const getLivros = function (nome){
    let nomeLivro = nome.toLowerCase();
    let listaLivros = [];
    let livroJSON = {};
    let erro = true;
    ...
    livros.forEach(item =>{
        ...
        item.books.forEach (book => {
            //Localiza a palavra chave dentro do titilo do livro (usando o includes)
            if(book.title.toLowerCase().includes(nomeLivro))
            {
    ...
    livroJSON.total = listaLivros.length;
    livroJSON.livros = listaLivros;
